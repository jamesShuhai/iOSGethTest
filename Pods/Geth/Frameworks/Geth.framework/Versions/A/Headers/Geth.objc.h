...
@interface GethChainConfig : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) id _ref;
...
- (GethChainConfig*)ethereumChainConfig;
- (void)setEthereumChainConfig:(GethChainConfig*)v;
...
- (GethBigInt*)getCost;
- (NSData*)getData;
- (GethAddress*)getFrom:(NSError**)error;
- (int64_t)getGas;
- (GethBigInt*)getGasPrice;
- (GethHash*)getHash;
- (int64_t)getNonce;
...
- (GethAddress*)getTo;
- (GethBigInt*)getValue;
- (GethTransaction*)withSignature:(NSData*)sig error:(NSError**)error;
@end
...
FOUNDATION_EXPORT GethChainConfig* GethMainnetChainConfig();
...
FOUNDATION_EXPORT GethChainConfig* GethNewChainConfig();
...
FOUNDATION_EXPORT GethChainConfig* GethTestnetChainConfig();
